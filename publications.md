...
<div class="row" style="display: flex; align-items: center; margin-bottom: 20px;">
  <div class="column left" style="flex: 1;">
    <img align="left" width="100%" src="https://zhaoxinf.github.io/pic/cascade.jpg">
  </div>
  ...
  <div class="column right" style="flex: 2;">
    <p>
      ...
      Qingchen Yu, Shiying Duan, Xiaodong Li, Yuhua Wang, Zhiyu Li, Shiji Zhou, Yifan Sun, <strong>Zhaoxin Fan</strong>（通讯作者）<br/>
...
<div class="row" style="display: flex; align-items: center; margin-bottom: 20px;">
  ...
  <div class="column right" style="flex: 2;">
    <p>
      ...
      <em>IEEE Transactions on Multimedia (<strong>TMM</strong>)</em>, 2026.<br/>
...
<div class="row" style="display: flex; align-items: center; margin-bottom: 20px;">
  ...
  <div class="column right" style="flex: 2;">
    <p>
      ...
      Tianbao Zhang, Zhenyu Liang, Zhenbo Song, Nana Wang, Xiaomei Zhang, Xudong Cai, Zheng Zhu, Kejian Wu, Gang Wang, <strong>Zhaoxin Fan</strong>（corresponding author)<br/>
      <em>European Conference on Computer Vision  (<strong>ECCV</strong>)</em>, 2026.<br/>
...
<div class="row" style="display: flex; align-items: center; margin-bottom: 20px;">
  ...
  <div class="column right" style="flex: 2;">
    <p>
      ...
      Yuanze Hu, <strong>Zhaoxin Fan</strong> (corresponding author), Gen Li, Zhichao Yang, Xinyu Wang, Ye Qiu, Wenjun Wu, Kejian Wu, Yifan Sun, Xiaotie Deng, Jin Dong, Ziyu Jia<br/>
      <em>Information Fusion  (<strong>IF</strong>)</em>, 2026.<br/>
